  ...
  { 
    ...
    if ($this->form_validation->run() == false) { 
      ...
      if ($this->input->post("reset_pw") === 'TRUE') { 
        ...
        $this->session->set_flashdata('message_warning', 'Kata sandi untuk petugas <strong>' .  $user->id_user . '</strong> telah di reset ke default. <br> Kata sandi default : <strong>PLGN123</strong>'); 
      } 
